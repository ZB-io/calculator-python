...
- Feature file is at: `karate-tests/tests/kafka_v3_clusters_cluster_id_topics_get.feature`
...
```bash
java -Dkarate.config.dir=karate-tests/config -jar Downloads/karate-1.5.1.jar karate-tests/tests/kafka_v3_clusters_cluster_id_topics_get.feature
```
